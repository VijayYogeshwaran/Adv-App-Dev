...
function Privacy() {
  return (
    <div class="privacy-container"><h2>Privacy Policy of <span class="website_url">www.miniature.com</span></h2>

    <p>At <span class="website_name">MINIATURE STUDENT PORTAL</span>, we collect and manage user data according to the following Privacy Policy.</p>
    ...
    <p>We only use your personal information to provide you the <span class="website_name">MINIATURE STUDENT PORTAL</span> services or to communicate with you about the Website or the services.</p>
